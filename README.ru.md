...
Aetherphone имеет открытый исходный код, и вклад приветствуется. Начните с документации для разработчиков (на английском), затем прочитайте руководство по участию.

→ [Документация для разработчиков](docs/README.md) · [Руководство по участию](CONTRIBUTING.md)
