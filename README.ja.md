...
プライバシーと安全性を最優先しています。メッセージはエンドツーエンドで暗号化され、投稿と画像は明確なコンテンツルールのもとで AI モデレーションを通ります。

## ハイライト

- **ソーシャル**：Chirper のマイクロブログ、Aethergram の写真フィード、ボイスメモとグループ通話に対応した暗号化メッセージの ChocoChat、そして任意の 18+ コンパニオンアプリ Velvet。
