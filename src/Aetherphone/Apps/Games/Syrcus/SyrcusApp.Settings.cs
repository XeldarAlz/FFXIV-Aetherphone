...
{    private void DrawEmulatorSettings(PhoneTheme theme, float scale)
    {
        ...
        var filter = DrawLabeledSegments("syrcus.filter", videoCard.NextRow(), Loc.T(L.Games.VideoFilter),
            new[]
            {
        ...
        var orientation = DrawLabeledSegments("syrcus.orientation", videoCard.NextRow(),
        ...
        var fastForwardSpeed = DrawLabeledSegments("syrcus.fastForwardSpeed", fastForwardCard.NextRow(),
