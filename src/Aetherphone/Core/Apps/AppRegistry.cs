...
internal static class AppRegistry
{
    public static AppBundle BuildDefault(PhoneServices services, Action showAbout)
    {
        ...
        // KupoAI is hidden from this release. Code and logic remain intact; re-add this line to ship it again.
        ...
        apps.Add(new MusicApp(services.Radio, services.SongSearch, services.Playback, services.SongHistory, services.Playlists, services.Media, services.Http, services.Textures, new FeatureFlags(services.Http, services.AethernetSession), services.Analytics, services.Confirm));
