...
internal static class AppRegistry
{
    public static AppBundle BuildDefault(PhoneServices services, Action showAbout)
    {
        ...
        apps.Add(new DirectMessagesApp(new DirectMessagesStore(services.AethernetSession, new AethernetClient(services.Http, services.AethernetSession, "dm"), services.Notifications), contactBook, services.AethernetSession, services.RemoteImages, services.Lodestone, services.DmLauncher, photoLibrary, services.Http));
