...
internal static class HousingEndpoints
{
    ...
    public const string ChinaBaseUrl = "https://house.ffxiv.cyou/api";
    public const string ChinaDisplayName = "艾欧泽亚售楼中心";
    ...
    public static string ChinaSales(string baseUrl, uint worldId) =>
