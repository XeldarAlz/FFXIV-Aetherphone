...
internal static class ChromeInk
{
    public static readonly Vector4 CardBackground = new(0.075f, 0.090f, 0.105f, 0.85f);
    public static readonly Vector4 CardBackgroundSoft = new(0.090f, 0.105f, 0.120f, 0.55f);
    public static readonly Vector4 Border = new(0.22f, 0.25f, 0.30f, 1.00f);
