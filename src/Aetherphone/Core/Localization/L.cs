...
internal static class L
{
    ...
    internal static class Encryption
    {
        ...
        public static readonly LocString NewDeviceHint = new("encryption.newDeviceHint", "On a new computer, enter your account passphrase or recovery code and your chats come along with their full history.");
        ...
        public static readonly LocString LockedPassphraseBody = new("encryption.lockedPassphraseBody", "This device doesn't have your encryption key yet. Enter your account passphrase to unlock your chats here, with your full history.");
        public static readonly LocString PassphraseSectionTitle = new("encryption.passphraseSectionTitle", "Account passphrase");
        public static readonly LocString PassphraseNotSetBody = new("encryption.passphraseNotSetBody", "Set an account passphrase to back up your encryption key. Enter it on any new PC and your full chat history unlocks there.");
        public static readonly LocString PassphraseConfiguredBody = new("encryption.passphraseConfiguredBody", "Your key is backed up, protected by your passphrase. Enter the passphrase on a new PC to keep your full history.");
        public static readonly LocString PassphraseLabel = new("encryption.passphraseLabel", "Passphrase");
        public static readonly LocString PassphraseSetButton = new("encryption.passphraseSetButton", "Set passphrase");
        public static readonly LocString PassphraseChangeButton = new("encryption.passphraseChangeButton", "Change passphrase");
        public static readonly LocString PassphraseTooShort = new("encryption.passphraseTooShort", "Use at least 8 characters.");
        public static readonly LocString PassphraseSaved = new("encryption.passphraseSaved", "Passphrase saved. Your key is backed up.");
        public static readonly LocString PassphraseWrong = new("encryption.passphraseWrong", "That passphrase didn't work. Check it and try again.");
        public static readonly LocString EscrowPromptHint = new("encryption.escrowPromptHint", "Tip: set an account passphrase in Settings, under Encrypted Chats, so a new PC keeps your full history.");
