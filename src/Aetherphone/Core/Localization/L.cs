...
internal static class L
{
    ...
    internal static class Settings
    {
        ...
        public static readonly LocString LinkedDevices = new("settings.linkedDevices", "Linked Devices");
        public static readonly LocString LinkedDevicesHint = new("settings.linkedDevicesHint", "Use your Aethernet account in the Aetherphone app on your real phone.");
        public static readonly LocString LinkedDevicesScan = new("settings.linkedDevicesScan", "Scan this code with the Aetherphone app on your phone.");
        public static readonly LocString LinkedDevicesRefresh = new("settings.linkedDevicesRefresh", "The code refreshes automatically.");
        public static readonly LocString LinkedDevicesClaimTitle = new("settings.linkedDevicesClaimTitle", "Link this phone?");
        public static readonly LocString LinkedDevicesClaimBody = new("settings.linkedDevicesClaimBody", "{0} wants to sign in with your account.");
        public static readonly LocString LinkedDevicesApprove = new("settings.linkedDevicesApprove", "Link phone");
        public static readonly LocString LinkedDevicesDeny = new("settings.linkedDevicesDeny", "Not now");
        public static readonly LocString LinkedDevicesLinkedTitle = new("settings.linkedDevicesLinkedTitle", "Phone linked");
        public static readonly LocString LinkedDevicesLinkedBody = new("settings.linkedDevicesLinkedBody", "{0} is now signed in with your account.");
        public static readonly LocString LinkedDevicesAnother = new("settings.linkedDevicesAnother", "Link another phone");
        ...
        public static readonly LocString GameDataSection = new("settings.gameDataSection", "Game Data");
        ...
        public static readonly LocString PreferPhoneLocaleForGameDataHint = new("settings.preferPhoneLocaleForGameDataHint", "Zone, item, and other in-game names try this app's language first, then fall back to your game client's language.");
