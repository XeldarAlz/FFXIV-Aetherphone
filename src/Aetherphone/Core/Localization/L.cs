...
internal static class L
{
    ...
    internal static class Games
    {
        ...
        public static readonly LocString GameBoy = new("games.gameBoy", "Allagan Pocket");
        public static readonly LocString GenreEmulator = new("games.genreEmulator", "Emulator");
        public static readonly LocString GameBoyLibrary = new("games.gameBoyLibrary", "Allagan Pocket Library");
        public static readonly LocString EmulatorHubHint = new("games.emulatorHubHint", "{0} systems · independent libraries and settings");
        public static readonly LocString RecentlyPlayed = new("games.recentlyPlayed", "Recently played");
        public static readonly LocString EmulatorGameCount = new("games.emulatorGameCount", "{0} games");
        public static readonly LocString CoreMissingShort = new("games.coreMissingShort", "Core missing");
        public static readonly LocString GetStarterGame = new("games.getStarterGame", "Get {0}");
        public static readonly LocString StarterGameBody =
            new("games.starterGameBody", "{0} by {1} is free software under {2}. Downloading {3} from the author's release page.");
        public static readonly LocString StarterGameFailed =
            new("games.starterGameFailed", "Could not download the game. Check your connection and try again.");
        public static readonly LocString FindHomebrew = new("games.findHomebrew", "Find homebrew games");
        public static readonly LocString FindHomebrewHint =
            new("games.findHomebrewHint", "Opens pdroms.de, an archive of free games written for these systems.");
        public static readonly LocString CoreMegabytes = new("games.coreMegabytes", "{0} MB");
        public static readonly LocString CoreDownloadSize = new("games.coreDownloadSize", "Download · {0}");
        public static readonly LocString CoreDownloadTitle = new("games.coreDownloadTitle", "Download the {0} core?");
        public static readonly LocString CoreDownloadBody =
            new("games.coreDownloadBody", "{0} from buildbot.libretro.com. It is kept in the plugin's config folder, so you only download it once.");
        public static readonly LocString CoreDownloadAction = new("games.coreDownloadAction", "Download");
        public static readonly LocString CoreDownloading = new("games.coreDownloading", "Downloading…");
        public static readonly LocString CoreDownloadProgress = new("games.coreDownloadProgress", "{0}%");
        public static readonly LocString CoreDownloadFailed =
            new("games.coreDownloadFailed", "Could not download the core. Check your connection and try again.");
        public static readonly LocString ImportRom = new("games.importRom", "Import ROM");
        public static readonly LocString NoRoms = new("games.noRoms", "No games yet");
        public static readonly LocString RomHint = new("games.romHint", "Import a supported cartridge ROM or scan a folder.");
        public static readonly LocString Roms = new("games.roms", "ROMs");
        public static readonly LocString StartingCore = new("games.startingCore", "Starting emulator…");
        public static readonly LocString CoreMissing = new("games.coreMissing", "The bundled emulator core was not found");
        public static readonly LocString LoadFailed = new("games.loadFailed", "Could not start the game");
        public static readonly LocString EmulatorGames = new("games.emulatorGames", "Games");
        public static readonly LocString EmulatorSettings = new("games.emulatorSettings", "Settings");
        public static readonly LocString EmulatorSystems = new("games.emulatorSystems", "Systems");
        public static readonly LocString AllSystems = new("games.allSystems", "All");
        public static readonly LocString GamePaused = new("games.gamePaused", "Paused game");
        public static readonly LocString ContinueGame = new("games.continueGame", "Continue");
        public static readonly LocString StopGame = new("games.stopGame", "End game");
        public static readonly LocString Video = new("games.video", "Video");
        public static readonly LocString VideoFilter = new("games.videoFilter", "Filter");
        public static readonly LocString Orientation = new("games.orientation", "Gameplay orientation");
        public static readonly LocString Portrait = new("games.portrait", "Portrait");
        public static readonly LocString Landscape = new("games.landscape", "Landscape");
        public static readonly LocString FilterPixel = new("games.filterPixel", "Pixel perfect");
        public static readonly LocString FilterBalanced = new("games.filterBalanced", "Balanced");
        public static readonly LocString FilterSharp = new("games.filterSharp", "Sharp");
        public static readonly LocString FilterSmooth = new("games.filterSmooth", "Smooth");
        public static readonly LocString PixelFilterHint = new("games.pixelFilterHint", "Balanced is recommended: crisp pixels at any size with light smoothing. Pixel perfect uses only whole multiples.");
        public static readonly LocString InterfaceLayout = new("games.interfaceLayout", "Interface");
        public static readonly LocString EditInterface = new("games.editInterface", "Edit interface");
        public static readonly LocString HideOnScreenControls = new("games.hideOnScreenControls", "Hide on-screen controls");
        public static readonly LocString InterfaceLayoutHint = new("games.interfaceLayoutHint", "Move and resize the screen and each on-screen control freely.");
        public static readonly LocString LayoutEditor = new("games.layoutEditor", "Interface editor");
        public static readonly LocString LayoutEditorHint = new("games.layoutEditorHint", "Select and drag any element. Use - and + to resize it in 5% steps.");
        public static readonly LocString LayoutScreen = new("games.layoutScreen", "Screen");
        public static readonly LocString DsTopScreen = new("games.dsTopScreen", "Top screen");
        public static readonly LocString DsTouchScreen = new("games.dsTouchScreen", "Touch screen");
        public static readonly LocString LeftAnalog = new("games.leftAnalog", "Left analog stick");
        public static readonly LocString RightAnalog = new("games.rightAnalog", "Right analog stick");
        public static readonly LocString OptionEnabled = new("games.optionEnabled", "Enabled");
        public static readonly LocString OptionDisabled = new("games.optionDisabled", "Disabled");
        public static readonly LocString DsScreenLayout = new("games.dsScreenLayout", "Screen layout");
        public static readonly LocString DsLayoutTopBottom = new("games.dsLayoutTopBottom", "Top / bottom");
        public static readonly LocString DsLayoutBottomTop = new("games.dsLayoutBottomTop", "Bottom / top");
        public static readonly LocString DsLayoutLeftRight = new("games.dsLayoutLeftRight", "Left / right");
        public static readonly LocString DsLayoutRightLeft = new("games.dsLayoutRightLeft", "Right / left");
        public static readonly LocString DsLayoutHybridTop = new("games.dsLayoutHybridTop", "Hybrid: top main");
        public static readonly LocString DsLayoutHybridBottom = new("games.dsLayoutHybridBottom", "Hybrid: bottom main");
        public static readonly LocString DsLayoutTopOnly = new("games.dsLayoutTopOnly", "Top screen only");
        public static readonly LocString DsLayoutBottomOnly = new("games.dsLayoutBottomOnly", "Bottom screen only");
        public static readonly LocString DsThreadedRenderer = new("games.dsThreadedRenderer", "Threaded software renderer");
        public static readonly LocString DsStylusCursor = new("games.dsStylusCursor", "Stylus cursor");
        public static readonly LocString DsCursorTouching = new("games.dsCursorTouching", "While touching");
        public static readonly LocString DsCursorTimeout = new("games.dsCursorTimeout", "Temporarily");
        public static readonly LocString DsCursorNever = new("games.dsCursorNever", "Hidden");
        public static readonly LocString DsMicrophoneSource = new("games.dsMicrophoneSource", "Microphone button");
        public static readonly LocString DsMicrophoneBlow = new("games.dsMicrophoneBlow", "Simulated blowing");
        public static readonly LocString DsMicrophoneSilence = new("games.dsMicrophoneSilence", "Silence");
        public static readonly LocString DsWifiMode = new("games.dsWifiMode", "Nintendo DS Wi-Fi");
        public static readonly LocString DsWifiIndirect = new("games.dsWifiIndirect", "Enabled (emulated network)");
        public static readonly LocString DsControlMicrophone = new("games.dsControlMicrophone", "Microphone");
        public static readonly LocString DsControlNextLayout = new("games.dsControlNextLayout", "Next screen layout");
        public static readonly LocString DsControlCloseLid = new("games.dsControlCloseLid", "Close lid");
        public static readonly LocString DsControlTouchJoystick = new("games.dsControlTouchJoystick", "Touch with joystick");
        public static readonly LocString DsTouchHint = new("games.dsTouchHint", "Click or hold directly on the emulated screens to use the stylus. L2 simulates the microphone; R2 cycles screen layouts.");
        public static readonly LocString PspFrameskip = new("games.pspFrameskip", "Frameskip");
        public static readonly LocString PspFrameskipOne = new("games.pspFrameskipOne", "Skip 1 frame");
        public static readonly LocString PspFrameskipTwo = new("games.pspFrameskipTwo", "Skip 2 frames");
        public static readonly LocString PspFrameskipThree = new("games.pspFrameskipThree", "Skip 3 frames");
        public static readonly LocString PspAutoFrameskip = new("games.pspAutoFrameskip", "Automatic frameskip");
        public static readonly LocString PspConfirmationButton = new("games.pspConfirmationButton", "Confirmation button");
        public static readonly LocString PspCross = new("games.pspCross", "Cross (×)");
        public static readonly LocString PspCircle = new("games.pspCircle", "Circle (○)");
        public static readonly LocString PspWlan = new("games.pspWlan", "Networking / WLAN");
        public static readonly LocString PspBuiltInAdHocServer = new("games.pspBuiltInAdHocServer", "Built-in PRO Ad Hoc server");
        public static readonly LocString PspAdHocServer = new("games.pspAdHocServer", "PRO Ad Hoc server");
        public static readonly LocString PspServerSocom = new("games.pspServerSocom", "socom.cc");
        public static readonly LocString PspServerGameplayer = new("games.pspServerGameplayer", "psp.gameplayer.club");
        public static readonly LocString PspServerSushi = new("games.pspServerSushi", "myneighborsushicat.com");
        public static readonly LocString PspServerLocalhost = new("games.pspServerLocalhost", "Local computer");
        public static readonly LocString PspSoftwareRendererHint = new("games.pspSoftwareRendererHint", "PPSSPP is configured to use its safe software renderer inside FFXIV. This mode is fixed to the native 480×272 resolution and can be CPU intensive.");
        public static readonly LocString ResetInterface = new("games.resetInterface", "Restore layout");
        public static readonly LocString FinishEditing = new("games.finishEditing", "Done");
        public static readonly LocString KeyboardControls = new("games.keyboardControls", "Keyboard controls");
        public static readonly LocString PressKey = new("games.pressKey", "Press a key…");
        public static readonly LocString ResetControls = new("games.resetControls", "Restore default controls");
        public static readonly LocString ControlsHint = new("games.controlsHint", "Select a command, then press the new key. Escape cancels.");
        public static readonly LocString ControlUp = new("games.controlUp", "Up");
        public static readonly LocString ControlDown = new("games.controlDown", "Down");
        public static readonly LocString ControlLeft = new("games.controlLeft", "Left");
        public static readonly LocString ControlRight = new("games.controlRight", "Right");
        public static readonly LocString ScanFolder = new("games.scanFolder", "Scan folder");
        public static readonly LocString RomBrowser = new("games.romBrowser", "Choose a ROM");
        public static readonly LocString FolderBrowser = new("games.folderBrowser", "Choose ROM folder");
        public static readonly LocString SelectFolder = new("games.selectFolder", "Use this folder");
        public static readonly LocString ParentFolder = new("games.parentFolder", "Parent folder");
        public static readonly LocString Drives = new("games.drives", "Drives");
        public static readonly LocString NoSubfolders = new("games.noSubfolders", "No subfolders here");
        public static readonly LocString NoCompatibleRoms = new("games.noCompatibleRoms", "No compatible ROMs here");
        public static readonly LocString RomFolders = new("games.romFolders", "ROM folders");
        public static readonly LocString RemoveFolder = new("games.removeFolder", "Remove");
        public static readonly LocString RomFolderHint = new("games.romFolderHint", "Folders are scanned recursively. ROMs stay in their original location.");
        public static readonly LocString SaveStates = new("games.saveStates", "Save states");
        public static readonly LocString StateSlot = new("games.stateSlot", "Slot");
        public static readonly LocString SaveState = new("games.saveState", "Save state");
        public static readonly LocString LoadState = new("games.loadState", "Load state");
        public static readonly LocString StateSaved = new("games.stateSaved", "State saved in slot {0}");
        public static readonly LocString StateLoaded = new("games.stateLoaded", "State loaded from slot {0}");
        public static readonly LocString StateMissing = new("games.stateMissing", "Slot {0} is empty");
        public static readonly LocString AutoSaveState = new("games.autoSaveState", "Auto-save when leaving game");
        public static readonly LocString AutoLoadState = new("games.autoLoadState", "Auto-load on game start");
        public static readonly LocString AutoStateHint = new("games.autoStateHint", "Automatic resume uses its own slot and never overwrites slots 1-5.");
        public static readonly LocString FastForward = new("games.fastForward", "Fast-forward");
        public static readonly LocString FastForwardSpeed = new("games.fastForwardSpeed", "Speed");
        public static readonly LocString FastForwardHint = new("games.fastForwardHint", "Tap FF on the game controls or assign a shortcut below. Tap FF again to stop.");
        public static readonly LocString EmulatorShortcuts = new("games.emulatorShortcuts", "Shortcuts");
        public static readonly LocString PressCombination = new("games.pressCombination", "Press and release a combination…");
